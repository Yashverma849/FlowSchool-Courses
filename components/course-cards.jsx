...
export function CourseCards() {
  return (
    <div className="flex-1 p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Flow Arts Courses</h1>
        <p className="text-gray-600">Discover the art of movement, rhythm, and creative expression</p>
